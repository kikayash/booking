            ...
            <div class="col-md-3 col-lg-2">
                <div class="card shadow mb-4">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="admin_add_booking.php" class="list-group-item list-group-item-action active <?= basename($_SERVER['PHP_SELF']) == 'admin_add_booking.php' ? 'active' : '' ?>">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <ul class="mb-0">
                                            ...
                                            <li>Booking hanya dapat dilakukan pada hari kerja dan dalam jam operasional (07:00 - 17:00).</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
